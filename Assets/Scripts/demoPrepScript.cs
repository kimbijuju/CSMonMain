...
public class demoPrepScript : MonoBehaviour
{
    ...
    void Start()
    {
        PokeList.ObtainedList.Add(new PokeList.CSMon(100, "", (PokeList.Yunxin.hp)*100, PokeList.Yunxin));
        ...
        PokeList.ObtainedList.Add(new PokeList.CSMon(100, "", (PokeList.Vanessa.hp)*100, PokeList.Vanessa));
        ...
        PokeList.enemyList.Add(new PokeList.CSMon(100, "", (PokeList.Emily.hp)*100, PokeList.Emily));
