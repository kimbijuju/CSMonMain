...
public class PokeList : MonoBehaviour
{
    ...
    void Start()
    {
         ...
         Daniel= new CSMonRef("Daniel", 110, 25, 10, 90, 20, "Devour", "Grass", DanielSprite, "If Devour lands, Daniel heals for 70% of Devour's damage");
         Derrick= new CSMonRef("Derrick", 50, 30, 70, 90, 20, "Tetris Smash", "Fire", DerrickSprite, "Uses the opponent's move, copying damage, crit chance, accuracy, and special effects");
         ...
         Nilesh= new CSMonRef("Nilesh", 70, 50, 40, 70, 20, "Blazing Mustache", "Fire", NileshSprite, "If Blazing Mustache lands, Nilesh's HP is set to 70% its current amount");
         ...
         Steve= new CSMonRef("Steve", 120 , 110, 10, 20, 10, "Rizz", "Water", SteveSprite, "If Rizz lands, Steve heals for 70% of Rizz's damage");
